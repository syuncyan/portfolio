  ...
  >
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <p>This is My Portfolio site you must watch this site </p>
      </div>
      ...
      <SquareBox pColor="" sColor="" text = "About" />
      <br>
      <SquareBox pColor="" sColor="" text = "Skills"/>
      <br>
      <SquareBox pColor="" sColor="" text = "Hobby"/>
      <br>
    </div>
  </div>
</template>
